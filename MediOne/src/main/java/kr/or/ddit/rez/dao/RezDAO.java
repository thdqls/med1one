...
public interface RezDAO {
	 ...
	 * @return 기존 예약 건
	 */
	public int selectUpdateMyRezConfirm(@Param("resveDate") String resevDate, @Param("fcltyCode") String fcltyCode, @Param("resveTime") String resveTime, @Param("patntCode") String patntCode);
