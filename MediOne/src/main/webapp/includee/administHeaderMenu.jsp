...
<!-- 	</ul> -->
	...
	<ul class="nav">
		<li class="nav-item">
			<a class="nav-link text-white fw-bold menuHover" style="margin-left: 100px; margin-right: 20px; margin-top: 5px;" href="${pageContext.request.contextPath }/administ/patientReceiptView.do" role="tab">
				<span class="fontStyle">외래접수</span>
			</a>
		</li>
	</ul>
	...
	<ul class="nav">
		<li class="nav-item">
			<a class="nav-link text-white fw-bold menuHover" style="margin-right: 20px; margin-top: 5px;" href="${pageContext.request.contextPath }/hospital/hospitalList.do" role="tab">
	...
	<ul class="nav">
		<li class="nav-item">
			<a class="nav-link text-white fw-bold menuHover" style="margin-right: 20px; margin-top: 5px;" href="${pageContext.request.contextPath }/rez/rezList.do" role="tab">
				<span class="fontStyle">예약현황</span>
			</a>
		</li>
	</ul>
	...
	<ul class="nav">
		<li class="nav-item">
			<a class="nav-link text-white fw-bold menuHover" style="margin-right: 20px; margin-top: 5px;" href="${pageContext.request.contextPath }/fixtures/fixturesReqInsert.do" role="tab">
				<span class="fontStyle">구매관리</span>
			</a>
		</li>
		<li class="nav-item">
			<a class="nav-link text-white fw-bold menuHover" style="margin-right: 20px; margin-top: 5px;" href="${pageContext.request.contextPath }/receive/receiveSearch.do" role="tab">
				<span class="fontStyle">수납</span>
			</a>
		</li>
		<li class="nav-item">
			<a class="nav-link text-white fw-bold menuHover" style="margin-right: 20px; margin-top: 5px;" href="${pageContext.request.contextPath }/message/messageSend.do" role="tab">
				<span class="fontStyle">SMS</span>
			</a>
		</li>
	</ul>
	...
	<div class="dropdown">
		<button class="btn btn-primary dropdown-toggle fw-bold menuHover" type="button"
		...
		<ul class="dropdown-menu border-0 shadow p-3">
			<li><a class="dropdown-item py-2 rounded "
				...
				href="${pageContext.request.contextPath }/notice/noticeList.do"><span
					class="fontStyle">공지사항</span></a></li>
			<li><a class="dropdown-item py-2 rounded"
				href="${pageContext.request.contextPath }/free/newFreeBoard.do"><span
					class="fontStyle">자유게시판</span></a></li>
			<li><a class="dropdown-item py-2 rounded" id="chatRoom"
				href="${pageContext.request.contextPath}/fixtures/fixturesOrder.do"><span class="fontStyle">비품신청</span></a></li>
		</ul>
	...
	<ul class="nav">  
    	<li class="profile"  style="margin-left: 348px;">
      	...
      	<li id="nav-item" class="nav-item">
		    <a class="nav-link text-white" href="${pageContext.request.contextPath}/mypage/mypage.do" role="tab" style=" margin-top: 5px;">
		        <span class="fontStyle">행정부 ${authMember.empNm}님</span>
		    </a>
		</li>
		<li id="nav-item" class="nav-item">
