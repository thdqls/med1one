...
<!-- 								<h5>인수인계</h5> -->
							...
							<div>
								<form id="nurseNoteForm">
									...
									<button class="btn btn-primary" style="margin-top:7px;" onclick="window.open('<%=request.getContextPath()%>/nurse/nurseNoteAllList.do','window_name','width=1300,height=700,left = 600,top=100,left=250px,location=no,status=no,scrollbars=yes')">이전일지 조회</button>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-12 col-lg-6" style="width: 100%; margin-right: 1px">
					<div class="card mb-3">
						...
						<div class="card-body">
							...
							<div class="tab-pane" id="tab6" role="tabpanel" aria-labelledby="tab6-tab">
								<div class="py-3">
									<span class="fs-5 fw-bolder">검사 결과</span>
								</div>
