										...
										<tr>
											<td>
												<button class="btn rezUpdateBtn" style="font-size:16px!important; font-weight: 700!important;"
													...
													value="${rezList.resveNum}"> <span style="color: #6c757d; text-decoration: underline;"> ${rezList.resveNum}</span></button>
											</td>
...
function allRezListLoad() {
	...
	$.getJSON("<c:url value='/rez/allRezList.do' />").done(function(resp) {
		...
		if (resp.length > 0) {
			...
			let tr = $("<tr>").append(
					$("<td>").html(
						    $("<button class='btn btn-primary rezUpdateBtn' data-bs-toggle='modal' data-bs-target='#draggableModal'></button>")
