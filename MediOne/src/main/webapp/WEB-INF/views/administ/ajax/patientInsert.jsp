...
<body class="d-flex flex-column vh-100">
		...
		<table id="patientFrom" class="table table-border">
			...
			<tr>
				...
				<td><form:input path="patntNm" name="patntNm"
						class="form-control" /> <form:errors path="patntNm" class="error" />
				</td>
			</tr>
			<tr>
				<th>주민번호</th>
				<td><form:input path="patntIdentino" name="patntIdentino"
						class="form-control" /> <form:errors path="patntIdentino"
						class="error" /></td>
			</tr>
			<tr>
				<th>전화번호</th>
			...
			<tr>
				...
				<td><form:input path="height" name="height"
						class="form-control" /> <form:errors path="height" class="error" />
				</td>
			</tr>
			<tr>
				<th>몸무게</th>
				<td><form:input path="weight" name="weight"
						class="form-control" /> <form:errors path="weight" class="error" />
				</td>
			</tr>
			<tr>
				<th>성별</th>
			...
			<tr>
				...
				<td><form:input path="patEmail" name="patEmail"
						class="form-control" /> <form:errors path="patEmail"
						class="error" /></td>
			</tr>
			<tr>
				<td colspan="2">
	...
	/* 	document.getElementById("submitButton").addEventListener("click",
		...
		document.getElementById("dataInsert").addEventListener("click",
				function() {
			document.getElementById("patntNm").value = "정은미"; 
		    document.getElementById("patntIdentino").value = "950516-2100111"; 
		    ...
		    document.getElementById("height").value = "160cm"; 
		    document.getElementById("weight").value = "50kg"; 
