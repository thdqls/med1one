									...
									<table class="table table-hover align-middle mb-0" style="width: 100%">
										<thead>
											<tr style="border-bottom: 1px solid black;">
												...
												<th style="width: 129px;">직원명</th>
												<th style="width: 262px;">주민번호</th>
												<th style="width: 204px;">부서명</th>
												<th style="width: 91px;">승인상태</th>
												<th style="width: 193px;">승인신청일시</th>
												<th style="width: 116px;">OTP(여/부)</th>
            ...
            if (list.reqStatus === "N") {
              ...
              if(list.emp.empOtp === null ) {
               ...
               var tr = $("<tr>").append(
                       ...
                       ,$("<td>").html(list.dept.deptNm).attr("style","width: 219px; text-align:right;")
                       ,$("<td>").html(stat).attr("style","width:121px; text-align:right;")
                       ,$("<td>").html(list.authoreqDate).attr("style","width:163px; text-align:right;")
                       ,$("<td>").html(list.emp.empOtp).attr("style","width:122px; text-align:right;")
