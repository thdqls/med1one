...
<c:url value='/free/freeList.do' var="listURL"></c:url>
						<a class="btn btn-light" style="text-align: right;" href="${listURL}"><i class="icofont-exit" style="size: 200px;"></i></a> 
							<table class="table table-border" style="text-align: center;">
								...
								<tr>
									<th>내&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;용</th>
									<td colspan="3"><form:textarea path="boardContent" class="form-control" /> 
									<form:errors path="boardContent" class="error" /></td>
								</tr>
							...
							<table style="text-align: center; margin: 20px;">
								<tr>
									<td>
										...
										<a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal" style="margin-left: 10px;">삭제</a>
										</td>
								</tr>
							</table>
