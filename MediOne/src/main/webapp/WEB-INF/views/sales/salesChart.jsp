                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="card" style="width:30%; margin-right: 5%; margin-bottom: 5%;">
                                             <div class="card-body ">
                                                ...
                                                &nbsp;<span class="text-danger" id="eightDoctorCount"></span><span style="font-size: 13px; color: grey;">&nbsp;명</span>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="card" style="width:30%; margin-right: 5%; margin-bottom: 5%;">
                                           <div class="card-body ">
												...
												&nbsp;<span class="text-danger" id="eightNurseCount"></span><span style="font-size: 13px; color: grey;">&nbsp;명</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
...
$(document).ready(function() {
	        $.getJSON("<c:url value='/sales/jobEmpChart.do' />").done(function(resp) {
	            ...
	            $(resp).each(function(idx, jobChart) {
	                  ...
	                  var doctor = resp[1];
	                  var nurse= resp[0];
	                  var eightStaffCount = staff.jobEmpCount;
	                  var eightDoctorCount = doctor.jobEmpCount;
	                  var eightNurseCount = nurse.jobEmpCount;

	                  // 가져온 직군별 직원수 값을 <div> 영역에 넣기
	                  $("#eightEmpCount").text(eightStaffCount);
	                  $("#eightDoctorCount").text(eightDoctorCount);
	                  $("#eightNurseCount").text(eightNurseCount);
    ...
    $.getJSON("<c:url value='/sales/countMonth2.do' />").done(function(resp) {
      console.log("월환자수",resp);
       ...
       /*  var currentMonth = (currentDate.getMonth() + 1).toString().padStart(2, '0'); // 0부터 시작하므로 1을 더하고 2자리로 패딩 */
		var currentMonthNumber = currentDate.getMonth() + 1; // 현재 월의 숫자 (9월의 경우 9)
        ...
        $(resp).each(function(idx, monthChart) {
            ...
            if (year === currentYear &&  month === currentMonth) {
               ...
               $("#eightClinicCount").text(eightMonthCount);
           }
       });
    });  
